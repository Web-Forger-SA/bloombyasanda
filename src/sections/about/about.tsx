    ...
    <div className='about_section-left'>
      ...
      <article className='about_section-left-article'>
        ...
        <div className='about_section-left-text-content'>
          ...
          <br />
          <p>From structured totes to delicate mini bags, every piece in our collection is chosen for quality, style, and longevity — whether you're shopping for yourself or building a boutique business.</p>
        </div>
      </article>
